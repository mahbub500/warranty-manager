<?php
/**
 * Plugin Name: Warranty Managment
 * Description: This is warranty managment.
 * Plugin URI: https://codexpert.io
 * Author: Codexpert, Inc
 * Author URI: https://codexpert.io
 * Version: 0.9
 * Text Domain: warranty-managment
 * Domain Path: /languages
 */

namespace Codexpert\Warranty_Managment;
...
final class Plugin {
	...
	private function define() {
		 ...
		 * @since 0.9
		 */
		define( 'WARRANTY_MANAGMENT', __FILE__ );
		define( 'WARRANTY_MANAGMENT_DIR', dirname( WARRANTY_MANAGMENT ) );
		define( 'WARRANTY_MANAGMENT_ASSET', plugins_url( 'assets', WARRANTY_MANAGMENT ) );
		define( 'WARRANTY_MANAGMENT_DEBUG', apply_filters( 'warranty-managment_debug', true ) );
		 ...
		 * @var $plugin
		 */
		$this->plugin					= get_plugin_data( WARRANTY_MANAGMENT );
		$this->plugin['basename']		= plugin_basename( WARRANTY_MANAGMENT );
		$this->plugin['file']			= WARRANTY_MANAGMENT;
		$this->plugin['server']			= apply_filters( 'warranty-managment_server', 'https://codexpert.io/dashboard' );
		$this->plugin['min_php']		= '5.6';
		$this->plugin['min_wp']			= '4.0';
		$this->plugin['icon']			= WARRANTY_MANAGMENT_ASSET . '/img/icon.png';
